...
<head>
    ...
    <style>
        ...
        .card {
            ...
            margin: 0; /* Remove default margin for cards */
        }
        .card:hover {
...
.carousel-inner {
    position: relative; /* Ensure that the positioning is relative to the carousel container */
}
...
.carousel-control-prev, .carousel-control-next {
    ...
    height: 40%;
    background-color: rgba(0, 0, 0, 0.3); /* Optional: Background color for better visibility */
...
.carousel-control-prev-icon, .carousel-control-next-icon {
    background-color: rgba(0, 0, 0, 0.5); /* Optional: Background color for the icons */
    border-radius: 50%; /* Optional: Round background for the icons */
    width: 2rem; /* Adjust width of the icons */
    height: 2rem; /* Adjust height of the icons */
}
    ...
    <div class="container my-5">
        <div id="newsCarousel" class="carousel slide">
            <div class="carousel-inner">
                <?php
                $items = array_chunk($rs_news->fetch_all(MYSQLI_ASSOC), 3); // Split news items into chunks of 3
                $first = true; // Flag to set the first carousel item as active
                foreach($items as $chunk): ?>
                    <div class="carousel-item <?php echo $first ? 'active' : ''; ?>">
                        <div class="row">
                            <?php foreach($chunk as $datanews): ?>
                                <?php
                    ...
                    <?php $first = false; // Reset flag after the first item ?>
                <?php endforeach; ?>
            </div>
